...
Pipeline:
  ...
  6. Evaluate the SAME model on the SAME 50 pools under three query settings:
       - Fact-only:  [FACT] fact
...
# DeepSeek settings — key is loaded from environment variable.
# Set it before submitting:  export DEEPSEEK_API_KEY="sk-..."
...
if not DEEPSEEK_API_KEY:
    ...
    print("Set it in your shell before submitting:")
