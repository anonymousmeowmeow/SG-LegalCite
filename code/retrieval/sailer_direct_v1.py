# ============================================================
# SG-LegalCite Stage 2 Direct Baseline — SAILER
...
OUTPUT_DIR    = "./citation_rec_sailer_direct_v1"
MAX_LENGTH    = 512
...
def evaluate_pools(model, tokenizer, label):
    print(f"\n{'='*60}")
    print(f"  {label} — SAILER Direct Baseline")
...
# ════════════════════════════════════════════════════════════
print("\n" + "="*60)
print("  PART 1: Zero-Shot SAILER — Direct Baseline")
print("="*60)
...
# ════════════════════════════════════════════════════════════
print("\n" + "="*60)
print("  PART 2: Fine-Tuning SAILER — Facts → Cited Case")
print("="*60)
...
# ════════════════════════════════════════════════════════════
print("\n" + "="*60)
print("  PART 3: Fine-Tuned SAILER — Direct Baseline")
print("="*60)
...
# ════════════════════════════════════════════════════════════
print("\n\n" + "="*60)
print("  SAILER DIRECT BASELINE FINAL RESULTS")
...
summary_df.to_csv(f"{OUTPUT_DIR}/sailer_direct_v1_results.csv")
print(f"\n✓ Results saved to: {OUTPUT_DIR}/sailer_direct_v1_results.csv")
