# ============================================================
# SG-LegalCite Stage 2 Direct Baseline — Legal-en-RoBERTa Large
...
# ── CONFIG — identical to Legal BERT / SBERT / Custom Legal-BERT / Longformer / Pile-of-Law / SAILER ──
...
OUTPUT_DIR    = "./citation_rec_roberta_large_direct_v1"
MAX_LENGTH    = 512
...
def evaluate_pools(model, tokenizer, label):
    print(f"\n{'='*60}")
    print(f"  {label} — Legal-en-RoBERTa Large Direct Baseline")
    ...
    fact_embs = encode_texts(model, tokenizer, unique_facts)
...
# ════════════════════════════════════════════════════════════
print("\n" + "="*60)
print("  PART 1: Zero-Shot Legal-en-RoBERTa Large — Direct Baseline")
print("="*60)
...
# ════════════════════════════════════════════════════════════
print("\n" + "="*60)
print("  PART 2: Fine-Tuning Legal-en-RoBERTa Large — Facts → Cited Case")
print("="*60)
...
# ════════════════════════════════════════════════════════════
print("\n" + "="*60)
print("  PART 3: Fine-Tuned Legal-en-RoBERTa Large — Direct Baseline")
print("="*60)
...
# ════════════════════════════════════════════════════════════
print("\n\n" + "="*60)
print("  LEGAL-EN-ROBERTA LARGE DIRECT BASELINE FINAL RESULTS")
...
summary_df.to_csv(f"{OUTPUT_DIR}/roberta_large_direct_v1_results.csv")
print(f"\n✓ Results saved to: {OUTPUT_DIR}/roberta_large_direct_v1_results.csv")
